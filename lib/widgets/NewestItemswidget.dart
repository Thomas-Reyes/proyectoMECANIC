...
class NewestItemswidget2 extends StatelessWidget {
  const NewestItemswidget2({Key? key}) : super(key: key);
...
class NewestItemswidget3 extends StatelessWidget {
  const NewestItemswidget3({Key? key}) : super(key: key);
